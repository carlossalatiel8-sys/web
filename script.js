const products = [
  ...
  { id: 'a-ti-me-rindo-hillsong', name: 'A Ti Me Rindo — Hillsong', category: 'Worship', price: 50, usd: '3.00', art: "linear-gradient(135deg,#0002,#0008),url('assets/a-ti-me-rindo-hillsong.jpg') center/cover", image: 'assets/a-ti-me-rindo-hillsong.jpg', tags: ['Worship', 'Crunch', 'Ambient'], badges: ['Badcat Lynx', 'GP200'], description: 'Este preset está construido sobre un amplificador Badcat Lynx con un crunch de ganancia media. Está cargado de reverb y delay para acompañar la canción “A Ti Me Rindo” de Hillsong, combinando ataque, ambiente y definición.', demo: 'https://drive.google.com/file/d/1xT1EFy6IOeubN5SiMVja04AQ8moDwr9c/view?usp=sharing' },
  ...
  { id: 'vox-ac30-presets', name: 'Vox AC30 Presets', category: 'Pack', price: 120, usd: '7.10', art: "linear-gradient(135deg,#0002,#0008),url('assets/vox-ac30-presets.jpg') center/cover", image: 'assets/vox-ac30-presets.jpg', tags: ['Vox AC30', 'High Gain', 'NAM'], badges: ['3 PRESETS','GP200'], description: 'Vox AC30 Presets incluye 3 presets basados en una captura NAM de un Vox AC30 configurado con ganancia alta. Ofrecen brillo, definición, saturación y sustain para riffs, leads y momentos intensos sin perder claridad.' },
  { id: 'carol-ann-presets', name: 'Carol Ann Presets', category: 'Metal', price: 120, usd: '7.10', art: "linear-gradient(135deg,#0002,#0008),url('assets/carol-ann-presets.jpg') center/cover", image: 'assets/carol-ann-presets.jpg', tags: ['Carol Ann', 'High Gain', 'Metal'], badges: ['3 PRESETS','GP200'], description: 'Carol Ann Presets incluye 3 presets basados en una captura NAM de un Carol Ann configurado con ganancia alta. Ofrecen distorsión pesada, ataque definido y sustain para riffs, leads y canciones de metal, manteniendo claridad incluso con mucha ganancia.' },
  { id: 'jazz-chorus-presets', name: 'Jazz Chorus Presets', category: 'Clean', price: 130, usd: '7.70', art: "linear-gradient(135deg,#0002,#0008),url('assets/jazz-chorus-presets.jpg') center/cover", image: 'assets/jazz-chorus-presets.jpg', tags: ['Jazz Chorus', 'Clean', 'Funk', 'Ambient', 'Overdrive'], badges: ['4 PRESETS','NAM','GP200'], description: 'Jazz Chorus Presets incluye 4 presets basados en una captura NAM de un Roland Jazz Chorus. Reúne tonos clean, funk y ambient, cada uno con su overdrive correspondiente para añadir ganancia sin perder claridad, definición ni espacio.' },
  { id: 'pack-ac30-carol-jc', name: 'AC30 • Carol Ann • JC', category: 'Pack', price: 300, usd: '16.50', art: "linear-gradient(135deg,#0002,#0008),url('assets/ac30-carol-jc-pack.png') center/cover", image: 'assets/ac30-carol-jc-pack.png', tags: ['Vox AC30', 'Carol Ann', 'Jazz Chorus'], badges: ['10 PRESETS','GP200'], description: 'Pack de 10 presets construido alrededor de tres amplificadores clásicos: Vox AC30, Carol Ann y Roland Jazz Chorus. Incluye distintos caracteres clean, ambient y overdrive listos para usar en tu GP200.' },
